...
# 배경 이미지 불러오기
background = pygame.image.load("C:/Users/tlswl/Desktop/python-game/background.png")

# 캐릭터(스프라이트) 불러오기
character = pygame.image.load("C:/Users/tlswl/Desktop/python-game/character.png")
